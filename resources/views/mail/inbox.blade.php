...
@section('title','AdminLTE 2 | Inbox')
...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="{{ action('MailBoxController@compose') }}" class="btn btn-primary btn-block margin-bottom">Compose</a>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="{{ action('MailBoxController@inbox') }}"><i class="fas fa-inbox"></i> Inbox
