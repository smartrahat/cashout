...
@section('title','AdminLTE 2 | Compose')
...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="{{ action('MailBoxController@inbox') }}" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="{{ action('MailBoxController@inbox') }}"><i class="fas fa-inbox"></i> Inbox
