<?php $__env->startSection('title','AdminLTE 2 | General UI Elements'); ?>
    ...
    <section class="content">
        ...
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fas fa-tag"></i> Color Palette</h3>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <div class="alert alert-info alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <h4><i class="icon fas fa-info"></i> Alert!</h4>
            ...
            <div class="col-md-6">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fas fa-th"></i> Custom Tabs</li>
                    </ul>
                    <div class="tab-content">
