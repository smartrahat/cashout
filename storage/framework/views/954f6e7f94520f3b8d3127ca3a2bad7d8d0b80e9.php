<?php $__env->startSection('title','AdminLTE 2 | Dashboard'); ?>
            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fas fa-inbox"></i> Sales</li>
                    </ul>
                ...
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                            <div class="btn-group" data-toggle="btn-toggle">
                                <button type="button" class="btn btn-default btn-sm active"><i class="fas fa-square text-green"></i>
                                </button>
                                <button type="button" class="btn btn-default btn-sm"><i class="fas fa-square text-red"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="box-body chat" id="chat-box">
                        ...
                        <div class="item">
                            ...
                            <p class="message">
                                <a href="#" class="name">
                                    <small class="text-muted pull-right"><i class="far fa-clock"></i> 2:15</small>
                                    Mike Doe
                                </a>
                        ...
                        <div class="item">
                            ...
                            <p class="message">
                                <a href="#" class="name">
                                    <small class="text-muted pull-right"><i class="far fa-clock"></i> 5:15</small>
                                    Alexander Pierce
                                </a>
                                I would like to meet you to discuss the latest news about
                                the arrival of the new theme. They say it is going to be one the
                        ...
                        <div class="item">
                            ...
                            <p class="message">
                                <a href="#" class="name">
                                    <small class="text-muted pull-right"><i class="far fa-clock"></i> 5:30</small>
                                    Susan Doe
                                </a>
                                I would like to meet you to discuss the latest news about
                                the arrival of the new theme. They say it is going to be one the
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <!-- Emphasis label -->
                                <small class="label label-danger"><i class="far fa-clock"></i> 2 mins</small>
                      ...
                      <span class="handle">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <small class="label label-info"><i class="far fa-clock"></i> 4 hours</small>
                                <div class="tools">
                                    <i class="fas fa-edit"></i>
                                    <i class="far fa-trash-alt"></i>
                                </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <small class="label label-warning"><i class="far fa-clock"></i> 1 day</small>
                                <div class="tools">
                                    <i class="fas fa-edit"></i>
                                    <i class="far fa-trash-alt"></i>
                                </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <input type="checkbox" value="">
                                <span class="text">Let theme shine like a star</span>
                                <small class="label label-success"><i class="far fa-clock"></i> 3 days</small>
                                <div class="tools">
                                    <i class="fas fa-edit"></i>
                                    <i class="far fa-trash-alt"></i>
                                </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <small class="label label-primary"><i class="far fa-clock"></i> 1 week</small>
                                <div class="tools">
                                    <i class="fas fa-edit"></i>
                                    <i class="far fa-trash-alt"></i>
                                </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fas fa-ellipsis-v"></i>
                                ...
                                <input type="checkbox" value="">
                                <span class="text">Let theme shine like a star</span>
                                <small class="label label-default"><i class="far fa-clock"></i> 1 month</small>
                                <div class="tools">
                                    <i class="fas fa-edit"></i>
                                    <i class="far fa-trash-alt"></i>
                                </div>
                    ...
                    <div class="box-footer clearfix no-border">
                        <button type="button" class="btn btn-default pull-right"><i class="fas fa-plus"></i> Add item</button>
                    </div>
                </div>
                <!-- /.box -->
            ...
            <section class="col-lg-5 connectedSortable">
                ...
                <div class="box box-solid bg-teal-gradient">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <button type="button" class="btn bg-teal btn-sm" data-widget="collapse"><i class="fas fa-minus"></i>
                            </button>
                            <button type="button" class="btn bg-teal btn-sm" data-widget="remove"><i class="fas fa-times"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="box box-solid bg-green-gradient">
                    <div class="box-header">
                        ...
                        <div class="pull-right box-tools">
                            ...
                            <button type="button" class="btn btn-success btn-sm" data-widget="collapse"><i class="fas fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-success btn-sm" data-widget="remove"><i class="fas fa-times"></i>
                            </button>
                        </div>
                        <!-- /. tools -->
                    </div>
