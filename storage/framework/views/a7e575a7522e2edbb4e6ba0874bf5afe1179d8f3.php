<?php $__env->startSection('title','AdminLTE 2 | Calendar'); ?>
                    ...
                    <div class="box-body">
                        <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
                            ...
                            <ul class="fc-color-picker" id="color-chooser">
                                <li><a class="text-aqua" href="#"><i class="fas fa-square"></i></a></li>
                                <li><a class="text-blue" href="#"><i class="fas fa-square"></i></a></li>
                                <li><a class="text-light-blue" href="#"><i class="fas fa-square"></i></a></li>
